...
var IstevenHelperService = /** @class */ (function () {
    function IstevenHelperService() {
    }
    return IstevenHelperService;
}());
var IstevenController = /** @class */ (function (_super) {
    ...
    IstevenController.prototype.getFormElements = function () {
        ...
        this.formElements.push(selectButtons, inputField, clearButton, checkboxes);
        // this.formElements.push(inputField);
        // this.formElements.push(clearButton)
        // this.formElements.push(checkboxes);
    };
